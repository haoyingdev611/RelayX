// From https://github.com/facebook/react-native/pull/25718
...
const EventTarget1 = require("event-target-shim");
 ...
 */
export default class EventSource extends EventTarget1(...EVENT_SOURCE_EVENTS) {
  ...
  constructor(url: string, eventSourceInitDict?: any) {
    ...
    this._subscriptions.push(
      RCTNetworking.addListener("didReceiveNetworkResponse", (args: any) =>
        (this as any).__didReceiveResponse(...args)
      )
    );
    this._subscriptions.push(
      RCTNetworking.addListener(
        "didReceiveNetworkIncrementalData",
        (args: any) => (this as any).__didReceiveIncrementalData(...args)
      )
    );
    this._subscriptions.push(
      RCTNetworking.addListener("didCompleteNetworkResponse", (args: any) =>
        (this as any).__didCompleteResponse(...args)
      )
    );
